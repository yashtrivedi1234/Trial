...
export default function KaashtKartAbout() {
  return (
    <section className="kk-about" aria-label="About KaashtKart">
      <style>{`
      ...
      <div className="kk-about-wrap">
        <div className="kk-about-copy">
          ...
          <p>
            <span className="kk-about-highlight">Farmers Producers Organisation (FPO)</span>
          ...
          <p>
            ...
            <span className="kk-about-highlight">KaashtKart is an effort to provide a dedicated Direct to Customers (D2C) online marketplace.</span>{" "}
        ...
        <div className="kk-about-features">
          {FEATURES.map((feature) => (
            <article className="kk-feature" key={feature.title}>
              <div className="kk-feature-icon">{feature.icon}</div>
              <div>
                <h3 className="kk-feature-title">{feature.title}</h3>
                <p className="kk-feature-subtitle">{feature.subtitle}</p>
              </div>
            </article>
          ))}
        </div>
